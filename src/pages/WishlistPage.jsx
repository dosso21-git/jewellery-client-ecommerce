...
const WishlistPage = () => {
    ...
    >
        X
                    ...
                    <div key={product.id} className="border rounded-lg p-4 flex flex-col md:flex-row md:space-x-4 m-1">
...
//                 {wishlistProducts.map((product) => (
//                     <div key={product.id} className="border rounded-lg p-4 flex flex-col md:flex-row md:space-x-4 relative">
//                         {/* Remove Button */}
//                         <button
//                             onClick={() => handleRemoveFromWishlist(product.id)}
